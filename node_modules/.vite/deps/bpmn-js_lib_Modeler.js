...
function _(l3, u3, t4) {
  var i3, r3, o3, e4 = {};
  for (o3 in u3) "key" == o3 ? i3 = u3[o3] : "ref" == o3 ? r3 = u3[o3] : e4[o3] = u3[o3];
  ...
  return m(l3, e4, i3, r3, null);
}
function m(n3, t4, i3, r3, o3) {
  var e4 = { type: n3, props: t4, key: i3, ref: r3, __k: null, __: null, __b: 0, __e: null, __c: null, constructor: void 0, __v: null == o3 ? ++u : o3, __i: -1, __u: 0 };
...
function $() {
  for (var n3, u3, t4, r3, o3, f3, c3, s3 = 1; i.length; ) i.length > s3 && i.sort(e2), n3 = i.shift(), s3 = i.length, n3.__d && (t4 = void 0, r3 = void 0, o3 = (r3 = (u3 = n3).__v).__e, f3 = [], c3 = [], u3.__P && ((t4 = d({}, r3)).__v = r3.__v + 1, l.vnode && l.vnode(t4), O(u3.__P, t4, r3, u3.__n, u3.__P.namespaceURI, 32 & r3.__u ? [o3] : null, f3, null == o3 ? S(r3) : o3, !!(32 & r3.__u), c3), t4.__v = r3.__v, t4.__.__k[t4.__i] = t4, N(f3, t4, c3), r3.__e = r3.__ = null, t4.__e != o3 && C(t4)));
  $.__r = 0;
}
function I(n3, l3, u3, t4, i3, r3, o3, e4, f3, c3, s3) {
  var a3, h3, y3, w3, d3, g3, _3, m4 = t4 && t4.__k || v, b2 = l3.length;
  for (f3 = P(u3, l3, m4, f3, b2), a3 = 0; a3 < b2; a3++) null != (y3 = u3.__k[a3]) && (h3 = -1 == y3.__i ? p : m4[y3.__i] || p, y3.__i = a3, g3 = O(n3, y3, h3, i3, r3, o3, e4, f3, c3, s3), w3 = y3.__e, y3.ref && h3.ref != y3.ref && (h3.ref && B(h3.ref, null, y3), s3.push(y3.ref, y3.__c || w3, y3)), null == d3 && null != w3 && (d3 = w3), (_3 = !!(4 & y3.__u)) || h3.__k === y3.__k ? f3 = A(y3, f3, n3, _3) : "function" == typeof y3.type && void 0 !== g3 ? f3 = g3 : w3 && (f3 = w3.nextSibling), y3.__u &= -7);
  return u3.__e = d3, f3;
}
function P(n3, l3, u3, t4, i3) {
  var r3, o3, e4, f3, c3, s3 = u3.length, a3 = s3, h3 = 0;
  for (n3.__k = new Array(i3), r3 = 0; r3 < i3; r3++) null != (o3 = l3[r3]) && "boolean" != typeof o3 && "function" != typeof o3 ? ("string" == typeof o3 || "number" == typeof o3 || "bigint" == typeof o3 || o3.constructor == String ? o3 = n3.__k[r3] = m(null, o3, null, null, null) : w(o3) ? o3 = n3.__k[r3] = m(k, { children: o3 }, null, null, null) : null == o3.constructor && o3.__b > 0 ? o3 = n3.__k[r3] = m(o3.type, o3.props, o3.key, o3.ref ? o3.ref : null, o3.__v) : n3.__k[r3] = o3, f3 = r3 + h3, o3.__ = n3, o3.__b = n3.__b + 1, -1 != (c3 = o3.__i = L(o3, u3, f3, a3)) && (a3--, (e4 = u3[c3]) && (e4.__u |= 2)), null == e4 || null == e4.__v ? (-1 == c3 && (i3 > s3 ? h3-- : i3 < s3 && h3++), "function" != typeof o3.type && (o3.__u |= 4)) : c3 != f3 && (c3 == f3 - 1 ? h3-- : c3 == f3 + 1 ? h3++ : (c3 > f3 ? h3-- : h3++, o3.__u |= 4))) : n3.__k[r3] = null;
  if (a3) for (r3 = 0; r3 < s3; r3++) null != (e4 = u3[r3]) && 0 == (2 & e4.__u) && (e4.__e == t4 && (t4 = S(e4)), D(e4, e4));
  return t4;
}
function A(n3, l3, u3, t4) {
  var i3, r3;
  if ("function" == typeof n3.type) {
    for (i3 = n3.__k, r3 = 0; i3 && r3 < i3.length; r3++) i3[r3] && (i3[r3].__ = n3, l3 = A(i3[r3], l3, u3, t4));
    return l3;
  }
...
function L(n3, l3, u3, t4) {
  var i3, r3, o3, e4 = n3.key, f3 = n3.type, c3 = l3[u3], s3 = null != c3 && 0 == (2 & c3.__u);
  if (null === c3 && null == e4 || s3 && e4 == c3.key && f3 == c3.type) return u3;
  if (t4 > (s3 ? 1 : 0)) {
    for (i3 = u3 - 1, r3 = u3 + 1; i3 >= 0 || r3 < l3.length; ) if (null != (c3 = l3[o3 = i3 >= 0 ? i3-- : r3++]) && 0 == (2 & c3.__u) && e4 == c3.key && f3 == c3.type) return o3;
  }
  return -1;
}
function T(n3, l3, u3) {
...
function O(n3, u3, t4, i3, r3, o3, e4, f3, c3, s3) {
  var a3, h3, p3, v3, y3, _3, m4, b2, S2, C3, M2, $2, P3, A3, H, L2, T3, j3 = u3.type;
  if (null != u3.constructor) return null;
  128 & t4.__u && (c3 = !!(32 & t4.__u), o3 = [f3 = u3.__e = t4.__e]), (a3 = l.__b) && a3(u3);
  n: if ("function" == typeof j3) try {
    if (b2 = u3.props, S2 = "prototype" in j3 && j3.prototype.render, C3 = (a3 = j3.contextType) && i3[a3.__c], M2 = a3 ? C3 ? C3.props.value : a3.__ : i3, t4.__c ? m4 = (h3 = u3.__c = t4.__c).__ = h3.__E : (S2 ? u3.__c = h3 = new j3(b2, M2) : (u3.__c = h3 = new x(b2, M2), h3.constructor = j3, h3.render = E), C3 && C3.sub(h3), h3.state || (h3.state = {}), h3.__n = i3, p3 = h3.__d = true, h3.__h = [], h3._sb = []), S2 && null == h3.__s && (h3.__s = h3.state), S2 && null != j3.getDerivedStateFromProps && (h3.__s == h3.state && (h3.__s = d({}, h3.__s)), d(h3.__s, j3.getDerivedStateFromProps(b2, h3.__s))), v3 = h3.props, y3 = h3.state, h3.__v = u3, p3) S2 && null == j3.getDerivedStateFromProps && null != h3.componentWillMount && h3.componentWillMount(), S2 && null != h3.componentDidMount && h3.__h.push(h3.componentDidMount);
    else {
      if (S2 && null == j3.getDerivedStateFromProps && b2 !== v3 && null != h3.componentWillReceiveProps && h3.componentWillReceiveProps(b2, M2), u3.__v == t4.__v || !h3.__e && null != h3.shouldComponentUpdate && false === h3.shouldComponentUpdate(b2, h3.__s, M2)) {
    ...
    if (h3.context = M2, h3.props = b2, h3.__P = n3, h3.__e = false, P3 = l.__r, A3 = 0, S2) {
      for (h3.state = h3.__s, h3.__d = false, P3 && P3(u3), a3 = h3.render(h3.props, h3.state, h3.context), H = 0; H < h3._sb.length; H++) h3.__h.push(h3._sb[H]);
      h3._sb = [];
    } else do {
      h3.__d = false, P3 && P3(u3), a3 = h3.render(h3.props, h3.state, h3.context), h3.state = h3.__s;
    } while (h3.__d && ++A3 < 25);
    h3.state = h3.__s, null != h3.getChildContext && (i3 = d(d({}, i3), h3.getChildContext())), S2 && !p3 && null != h3.getSnapshotBeforeUpdate && (_3 = h3.getSnapshotBeforeUpdate(v3, y3)), L2 = a3, null != a3 && a3.type === k && null == a3.key && (L2 = V(a3.props.children)), f3 = I(n3, w(L2) ? L2 : [L2], u3, t4, i3, r3, o3, e4, f3, c3, s3), h3.base = u3.__e, u3.__u &= -161, h3.__h.length && e4.push(h3), m4 && (h3.__E = h3.__ = null);
  } catch (n4) {
    ...
    else u3.__e = t4.__e, u3.__k = t4.__k, n4.then || z(u3);
    l.__e(n4, u3, t4);
  }
  else null == o3 && u3.__v == t4.__v ? (u3.__k = t4.__k, u3.__e = t4.__e) : f3 = u3.__e = q(t4.__e, u3, t4, i3, r3, o3, e4, c3, s3);
...
function N(n3, u3, t4) {
  for (var i3 = 0; i3 < t4.length; i3++) B(t4[i3], t4[++i3], t4[++i3]);
...
function q(u3, t4, i3, r3, o3, e4, f3, c3, s3) {
  var a3, h3, v3, y3, d3, _3, m4, b2 = i3.props || p, k3 = t4.props, x3 = t4.type;
  ...
  if (null == x3) b2 === k3 || c3 && u3.data == k3 || (u3.data = k3);
    ...
    if (e4 = e4 && n.call(u3.childNodes), !c3 && null != e4) for (b2 = {}, a3 = 0; a3 < u3.attributes.length; a3++) b2[(d3 = u3.attributes[a3]).name] = d3.value;
    ...
    for (a3 in k3) d3 = k3[a3], "children" == a3 ? y3 = d3 : "dangerouslySetInnerHTML" == a3 ? h3 = d3 : "value" == a3 ? _3 = d3 : "checked" == a3 ? m4 = d3 : c3 && "function" != typeof d3 || b2[a3] === d3 || j(u3, a3, d3, b2[a3], o3);
    if (h3) c3 || v3 && (h3.__html == v3.__html || h3.__html == u3.innerHTML) || (u3.innerHTML = h3.__html), t4.__k = [];
    else if (v3 && (u3.innerHTML = ""), I("template" == t4.type ? u3.content : u3, w(y3) ? y3 : [y3], t4, i3, r3, "foreignObject" == x3 ? "http://www.w3.org/1999/xhtml" : o3, e4, f3, e4 ? e4[0] : i3.__k && S(i3, 0), c3, s3), null != e4) for (a3 = e4.length; a3--; ) g(e4[a3]);
...
function D(n3, u3, t4) {
  ...
  if (i3 = n3.__k) for (r3 = 0; r3 < i3.length; r3++) i3[r3] && D(i3[r3], u3, t4 || "function" != typeof n3.type);
...
function G(u3, t4, i3) {
  var r3, o3, e4, f3;
  t4 == document && (t4 = document.documentElement), l.__ && l.__(u3, t4), o3 = (r3 = "function" == typeof i3) ? null : i3 && i3.__k || t4.__k, e4 = [], f3 = [], O(t4, u3 = (!r3 && i3 || t4).__k = _(k, null, [u3]), o3 || p, p, t4.namespaceURI, !r3 && i3 ? [i3] : o3 ? null : t4.firstChild ? n.call(t4.childNodes) : null, e4, !r3 && i3 ? i3 : o3 ? o3.__e : t4.firstChild, r3, f3), N(e4, u3, f3);
}
...
var n2 = function(t4, s3, r3, e4) {
  var u3;
  s3[0] = 0;
  for (var h3 = 1; h3 < s3.length; h3++) {
    var p3 = s3[h3++], a3 = s3[h3] ? (s3[0] |= p3 ? 1 : 2, r3[s3[h3++]]) : s3[++h3];
    3 === p3 ? e4[0] = a3 : 4 === p3 ? e4[1] = Object.assign(e4[1] || {}, a3) : 5 === p3 ? (e4[1] = e4[1] || {})[s3[++h3]] = a3 : 6 === p3 ? e4[1][s3[++h3]] += a3 + "" : p3 ? (u3 = t4.apply(a3, n2(t4, a3, r3, ["", null])), e4.push(u3), a3[0] ? s3[0] |= 2 : (s3[h3 - 2] = 0, s3[h3] = u3)) : e4.push(a3);
  }
  return e4;
};
...
function htm_module_default(s3) {
  ...
  return r3 || (r3 = /* @__PURE__ */ new Map(), t2.set(this, r3)), (r3 = n2(this, r3.get(s3) || (r3.set(s3, r3 = (function(n3) {
    for (var t4, s4, r4 = 1, e4 = "", u3 = "", h3 = [0], p3 = function(n4) {
      1 === r4 && (n4 || (e4 = e4.replace(/^\s*\n\s*|\s*\n\s*$/g, ""))) ? h3.push(0, n4, e4) : 3 === r4 && (n4 || e4) ? (h3.push(3, n4, e4), r4 = 2) : 2 === r4 && "..." === e4 && n4 ? h3.push(4, n4, 0) : 2 === r4 && e4 && !n4 ? h3.push(5, 0, true, e4) : r4 >= 5 && ((e4 || !n4 && 5 === r4) && (h3.push(r4, 0, e4, s4), r4 = 6), n4 && (h3.push(r4, n4, 0, s4), r4 = 6)), e4 = "";
    }, a3 = 0; a3 < n3.length; a3++) {
      a3 && (1 === r4 && p3(), p3(a3));
      for (var l3 = 0; l3 < n3[a3].length; l3++) t4 = n3[a3][l3], 1 === r4 ? "<" === t4 ? (p3(), h3 = [h3], r4 = 3) : e4 += t4 : 4 === r4 ? "--" === e4 && ">" === t4 ? (r4 = 1, e4 = "") : e4 = t4 + e4[0] : u3 ? t4 === u3 ? u3 = "" : e4 += t4 : '"' === t4 || "'" === t4 ? u3 = t4 : ">" === t4 ? (p3(), r4 = 1) : r4 && ("=" === t4 ? (r4 = 5, s4 = e4, e4 = "") : "/" === t4 && (r4 < 5 || ">" === n3[a3][l3 + 1]) ? (p3(), 3 === r4 && (h3 = h3[0]), r4 = h3, (h3 = h3[0]).push(2, 0, r4), r4 = 0) : " " === t4 || "	" === t4 || "\n" === t4 || "\r" === t4 ? (p3(), r4 = 2) : e4 += t4), 3 === r4 && "!--" === e4 && (r4 = 4, h3 = h3[0]);
    }
    return p3(), h3;
...
var max = Math.max;
function circlePath(center2, r3) {
  var x3 = center2.x, y3 = center2.y;
  return [
    ["M", x3, y3],
    ["m", 0, -r3],
    ["a", r3, r3, 0, 1, 1, 0, 2 * r3],
    ["a", r3, r3, 0, 1, 1, 0, -2 * r3],
    ["z"]
  ];
}
...
function perpendicularFoot(point, line) {
  ...
  var r3 = solveLambaSystem([a3.x, a3.y], [bd.x, bd.y], [point.x, point.y]);
  return { x: a3.x + r3 * bd.x, y: a3.y + r3 * bd.y };
}
...
function ConnectionSegmentMove(injector, eventBus, canvas, dragging, graphicsFactory, modeling) {
  ...
  function filterRedundantWaypoints2(waypoints, segmentStartIndex) {
    var segmentOffset = 0;
    var filteredWaypoints = waypoints.filter(function(r3, idx) {
      if (pointsOnLine(waypoints[idx - 1], waypoints[idx + 1], r3)) {
...
function DeleteLaneBehavior(eventBus, spaceTool) {
  ...
  this.postExecuted("shape.delete", LOW_PRIORITY5, function(event2) {
...
function UpdateFlowNodeRefsBehavior(eventBus, modeling) {
  ...
  this.postExecuted(laneRefUpdateEvents, LOW_PRIORITY10, function(event2) {
    releaseContext();
  });
  this.preExecute([
    "shape.create",
...
function CreatePreview(canvas, eventBus, graphicsFactory, previewSupport, styles) {
  ...
  eventBus.on("create.move", LOW_PRIORITY11, function(event2) {
...
ToolManager.prototype.bindEvents = function(name, events) {
  ...
  eventBus.on(eventsToRegister, LOW_PRIORITY13, function(event2) {
    if (!this._active) {
      return;
    }
...
function SpaceToolPreview(eventBus, elementRegistry, canvas, styles, previewSupport) {
  ...
  eventBus.on("spaceTool.move", LOW_PRIORITY14, function(event2) {
...
ResizeLaneHandler.prototype.resizeBalanced = function(shape, newBounds) {
  ...
  resizeNeeded.forEach(function(r3) {
    modeling.resizeShape(r3.shape, r3.newBounds);
  });
};
...
function ResizePreview(eventBus, canvas, previewSupport) {
  ...
  eventBus.on("resize.move", LOW_PRIORITY19, function(event2) {
...
function Outline(eventBus, styles) {
  ...
  eventBus.on(["shape.added", "shape.changed"], LOW_PRIORITY20, function(event2) {
